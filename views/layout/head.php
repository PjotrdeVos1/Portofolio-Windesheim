...
<head>
    ...
    <link rel="stylesheet" href="/Portofolio/views/css/index.css">
</head>
<body>
<nav class="NavBar">
    <a href="/Portofolio/index.php">Home</a>
    <a href="/Portofolio/views/contact.view.php">Contact info</a>
    <a href="/Portofolio/views/info.view.php">Over mij</a>
</nav>
